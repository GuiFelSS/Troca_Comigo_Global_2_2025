package br.com.fiap.globalSolution.Rabbit.Controller;
...
public class EmailController {
    ...
    @GetMapping("/emails")
    public ResponseEntity<Page<EmailEntity>> getAllEmails(@PageableDefault(page = 0, size = 5, sort = "emailId", direction = Sort.Direction.DESC) Pageable pageable){
